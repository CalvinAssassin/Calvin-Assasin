...
//        public String[] fieldNames = { "playerID", "firstName", "lastName", "residence", "major",
//                "latitude", "longitude", "locUpdateTime", "gameID", "alive"
//        };
//
//        public String[] intFieldNames = { "playerID", "gameID" };
...
//        public String[] booleanFieldNames = { "alive" };
//
...
//            playerInfo.playerID = playerInfo.gameID = 0;
...
//    {
//        if ( !getValue( "gameID" ).equals("err") )
//            return (int) getValue( "gameID" );
//        return 0;
//    }
//
//}
